...
const { ZOKRATES_WORKER_HOST, PROVING_SCHEME, BACKEND, PROTOCOL, VK_IDS, TRANSACTION } = config;
...
async function manufacture(manfParams) {
  logger.info('Creating a manufacture transaction');
  ...
  try {
    ...
    const transaction = new Transaction({
      ...
      numberNullifiers: VK_IDS.manufacture.numberNullifiers,
      numberCommitments: VK_IDS.manufacture.numberCommitments,
      calculateHash: false,
    });
