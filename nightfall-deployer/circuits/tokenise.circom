...
template Tokenise(N,C) {
    ...
    // Check that the first commitment is differen than zero
...
component main {public [value, fee, transactionType, tokenType, historicRootBlockNumberL2, tokenId, ercAddress, recipientAddress, commitments, nullifiers, compressedSecrets,roots, feeAddress]} = Tokenise(2,2);
