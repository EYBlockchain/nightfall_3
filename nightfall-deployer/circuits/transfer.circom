 ...
 * @input tokenId[256] - {Array[Bool]}
 * @input ercAddress - {Field}
 * @input recipientAddress[256] - {Array[Bool]}
...
component main {public [value, fee, transactionType, tokenType, historicRootBlockNumberL2, tokenId, ercAddress, recipientAddress, commitments, nullifiers, compressedSecrets,roots, feeAddress]} = Transfer(4,3);
