...
async function deploy() {
  ...
  await db.put(config.contract.name, contractInstance._address); // eslint-disable-line no-underscore-dangle

  return contractInstance; // eslint-disable-line no-underscore-dangle
}
