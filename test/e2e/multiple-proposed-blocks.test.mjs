...
describe('Multiple proposed blocks', () => {
  let gasCost = 0;
  before(async () => {
  ...
  describe('Propose multiple L2 blocks', () => {
    it('should propose multiple blocks after deposits', async function () {
      let currentPkdBalance;
      try {
        currentPkdBalance = (await nf3Users[0].getLayer2Balances())[erc20Address][0].balance;
      } catch (e) {
        currentPkdBalance = 0;
      }
      ...
      // We start proposer to propose pending blocks
