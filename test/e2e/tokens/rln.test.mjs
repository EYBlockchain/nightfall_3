...
describe('RLN tests', () => {
  ...
  before(async () => {
    ...
    rlnAddress = await nf3User.getContractAddress('RLN');
    ...
    await nf3User.deposit(rlnAddress, tokenTypeERC1155, 50 * transferValue, _tokenId, fee);
  ...
  describe('Deposits', () => {
    it('Should increment user L2 balance after depositing some ERC1155', async function () {
      ...
      const res = await nf3User.deposit(rlnAddress, tokenTypeERC1155, transferValue, _tokenId, fee);
  ...
  describe('Transfer', () => {
    it('Should decrement user L2 balance after transferring some ERC1155 to other wallet, and increment the other wallet balance', async function () {
      const userL2RlnBeforeBalance = await getLayer2RlnBalance(nf3User);
  ...
  describe('Withdrawals', () => {
    ...
    before(async function () {
      ...
      await nf3User.deposit(rlnAddress, tokenTypeERC1155, transferValue, _tokenId, fee);
      await makeBlock();
