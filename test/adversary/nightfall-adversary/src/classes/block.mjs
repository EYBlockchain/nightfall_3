/* THIS FILE CONTAINS CODE THAT HAS BEEN AUTOGENERATED DO NOT MODIFY MANUALLY */
/**
...
class Block {
  ...
  static async build(components) {
    const { proposer, transactions, errorIndex } = components;
