...
import "./Ownable.sol";
import "./MerkleTree_Computations.sol";
...
contract Shield_Computations is Ownable, MerkleTree_Computations, Proposals  {
  ...
  MerkleTree_Computations private timber; // the timber contract
  ...
  */
  function depositComputation(
    ...
    ) internal returns(MerkleUpdate memory) {
    // gas measurement:
    uint256 gasCheckpoint = gasleft();
    bytes32[33] memory nullFrontier;
    ...
    MerkleUpdate memory merkleUpdate = insertLeaf(_commitment);
