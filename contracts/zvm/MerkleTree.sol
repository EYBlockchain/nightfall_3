...
import "../mimc/MiMC_BLS12_377.sol"; // import contract with MiMC function
// import "../access/Ownable.sol";

contract MerkleTree is MiMC_BLS12_377 {
    ...
    */
    ...
    uint[] public frontier; //  = new uint[](treeHeight + 1); // the right-most 'frontier' of nodes required to calculate the new root when the next new leaf value is added.
    ...
    constructor (uint _treeHeight) public {
      ...
      // frontier = new uint[](treeHeight + 1);
    }
