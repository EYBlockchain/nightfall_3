...
module.exports = {
  ...
  ENVIRONMENTS: {
    ...
    perfTest: {
      ...
      chainId: 1337,
      clientApiUrl: `http://${process.env.CLIENT_HOST}:${process.env.CLIENT_PORT}`,
      optimistApiUrl: `http://${process.env.OPTIMIST_HTTP_HOST}`,
      optimistWsUrl: `wss://${process.env.OPTIMIST_HOST}`,
      proposerBaseUrl: `http://${process.env.PROPOSER_HOST}`,
      web3WsUrl: `ws://${process.env.BLOCKCHAIN_WS_HOST}${process.env.BLOCKCHAIN_PATH}`,
      adversarialOptimistApiUrl: `http://${process.env.ADVERSARY_OPTIMIST_HTTP_HOST}`,
      adversarialOptimistWsUrl: `ws://${process.env.ADVERSARY_OPTIMIST_HOST}`,
      adversarialClientApiUrl: `http://${process.env.ADVERSARY_CLIENT_HTTP_HOST}`,
      adversarialClientWsUrl: `ws://${process.env.ADVERSARY_CLIENT_HOST}`,
      PROPOSER_KEY: process.env.PROPOSER_KEY,
      CHALLENGER_KEY: process.env.CHALLENGER_KEY,
    },
    polygonEdge: {
