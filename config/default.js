module.exports = {
  ...
  // given a URL. 
  optimistBaseUrl: process.env.DOMAIN_NAME === "" ? `http://${process.env.OPTIMIST_HOST}:${process.env.OPTIMIST_HTTP_PORT}` : `https://${process.env.OPTIMIST_HTTP_HOST}`,
  optimistWsUrl: process.env.DOMAIN_NAME === "" ? `ws://${process.env.OPTIMIST_HOST}:${process.env.OPTIMIST_WS_PORT}` : `wss://${process.env.OPTIMIST_HOST}`,
  web3WsUrl: process.env.DOMAIN_NAME === "" ? `ws://${process.env.BLOCKCHAIN_WS_HOST}:${process.env.BLOCKCHAIN_PORT}` : `wss://${process.env.BLOCKCHAIN_WS_HOST}`,
