...
and does not do any validity checks before it provides the advance. Do not use
this in production.
*/
...
import { Nf3, Constants, Environment, Tokens } from 'nightfall-sdk';
...
async function startProvider(testEnvironment) {
  ...
  await Tokens.approve(
    ...
    Constants.TOKEN_TYPE.ERC20,
    Constants.APPROVE_AMOUNT,
    nf3.web3,
  );
