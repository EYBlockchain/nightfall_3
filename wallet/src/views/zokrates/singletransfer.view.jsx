    ...
    initialize().then((zokratesProvider) => {
      ...
      const options = {
        ...
        resolveCallback: (currentLocation, importLocation) => {
          ...
          else if (importLocation.endsWith("mimc-encryption.zok"))
            code = mimcEncryption;
          else if (importLocation.endsWith("mimc-constants.zok"))
            code = mimcConstants;
          else if (importLocation.endsWith("pad512ThenHash.zok"))
            code = pad512ThenHash;
          else if (importLocation.endsWith("pad1280ThenHash.zok"))
            code = pad1280ThenHash;
          else if (importLocation.endsWith("pad3072ThenHash.zok"))
            code = pad3072ThenHash;
          ...
          else if (importLocation.endsWith("mimc-path-check.zok"))
            code = pathCheck;
      ...
      const publicInputsHash =
        "415417283559201812128556462617247713976080142505265392744951502712092195983";
      ...
      const ask =
        "6930558048592459968398874090872446840386493339700763487392344092914357738801";
      ...
      // generate proof
      const genProof = zokratesProvider.generateProof(
        artifacts.program,
        witness,
        keypair.pk
      );
