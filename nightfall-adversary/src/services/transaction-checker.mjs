  ...
  switch (Number(transaction.transactionType)) {
    ...
    case 0: // deposit
      if (
        ...
        (Number(transaction.tokenType) === 0 && transaction.tokenId !== ZERO) || // For ERC20, the tokenID has to be zero. token value can be anything from zero
        ...
        // For ERC1155 (Number(transaction.tokenType) === 3), both can be zero as they
